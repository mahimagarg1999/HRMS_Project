...
const ModalBox = ({ isOpen, onRequestClose, consultancyId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const mydata = { ...newdata,id: data._id };
        if (agreement !== '') {
                        ...
                        <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="consultancy_website_url" value={data.consultancy_website_url} onChange={handleInputChange} class="form-control" placeholder="Consultancy Website" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <a style={{ color: 'green' }} href={`http://localhost:5000/${data.contract_agreement}`} target="_blank">{data.contract_agreement == '' ? '' : 'Show Contract Agreement'}</a>
