...
const ModalBox = ({ isOpen, onRequestClose, profileId }) => {
            ...
            if (profileId) {
                const fetchData = async () => {
                    try {
                        ...
                        const response = await axios.get(`${BASE_API_URL}profiles/get?profileid=${profileId}`);
    ...
    const handleSubmit =async (e) => {
        ...
        try {
            const response =await axios.put(`${BASE_API_URL}profiles/edit`, data);
                    ...
                    <div class="signup-form">
                        ...
                        <CloseButton onClick={onRequestClose} />
                            ...
                            <div style={{ textAlign: 'center' }}>
                                ...
                                <h4 style={{ display: 'inline', marginRight: '10px' }} className="mb-5 text-secondary">Edit Profiles Data</h4>
