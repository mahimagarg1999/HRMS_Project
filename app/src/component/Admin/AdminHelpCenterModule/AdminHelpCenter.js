...
const HelpCenterModule = () => {
                                                            ...
                                                            <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <label><b>Employee Code</b></label>
                                                                        ...
                                                                        <input type="text" name="helpcenter_employee_id"  value={code} readOnly class="form-control" placeholder="Employee Id" />
 ...
 <div class="mb-3 col-md-6">    <label><b>Ticket Description*</b></label>

                                                                         <textarea type="text" name="helpcenter_ticket_description" value={formData.helpcenter_ticket_description} onChange={handleInputChange} class="form-control" placeholder="Ticket Discription" />
                                                                    </div>
